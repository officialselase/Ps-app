...
from .views import (
    ...
    TeamMemberViewSet, GalleryItemViewSet # New data views
)
...
router.register(r'team-members', TeamMemberViewSet) # NEW: Team Members API
router.register(r'gallery', GalleryItemViewSet) # NEW: Gallery API
